...
""",
    ...
    'data': [
        ...
        'wizards/views/create_commission_invoice_view.xml',
        'wizards/views/invoice_info_view.xml',
        'views/commission_calc_view.xml',
        'views/commission_rule_view.xml',
        'views/account_invoice_view.xml',
        'views/commission_calc_sequence.xml',
        'wizards/views/update_invoice_commission_view.xml',
        'wizards/views/generate_commission_worksheet_view.xml',
    ],
    'test': [
    ],
    'auto_install': False,
